...
{
    public async Task<IList<Language>> GetLanguages(string? country = null, string? language_code = null, string? language_name = null, bool? include_translations = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<LanguagesResult?> GetLanguagesPaginated(int page, string? country = null, string? language_code = null, string? language_name = null, bool? include_translations = null, int? limit = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<string?> GetLanguagesPaginatedJson(int page, string? country = null, string? language_code = null, string? language_name = null, bool? include_translations = null, int? limit = null, CancellationToken cancellationToken = default)
    {
        var request = GetLanguagesPaginatedRequest(page, country, language_code, language_name, include_translations, limit);
    ...
    public async Task<LanguageInfoResult?> GetLanguage(int languageId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<string?> GetLanguageJson(int languageId, CancellationToken cancellationToken = default)
    {
        var request = new HttpRequest(ApiEndpoints.GetLanguage(languageId));
        var response = await httpClient.ExecuteJsonAsync(request, cancellationToken).ConfigureAwait(false);
        return response;
    ...
    public async Task<IList<LanguageSearch>> SearchLanguages(string searchText, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<LanguageSearchResult?> SearchLanguagesPaginated(int page, string searchText, int? limit = null, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<string?> SearchLanguagesPaginatedJson(int page, string searchText, int? limit = null, CancellationToken cancellationToken = default)
    {
        var request = SearchLanguagesPaginatedRequest(page, searchText, limit);
        var response = await httpClient.ExecuteJsonAsync(request, cancellationToken).ConfigureAwait(false);
        return response;
